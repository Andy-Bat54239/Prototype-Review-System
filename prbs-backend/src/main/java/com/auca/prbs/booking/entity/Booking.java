...
public class Booking {
    ...
    @Column(nullable = false, length = 200)   private String project;

    @Column(name = "slot_at",        nullable = false) private LocalDateTime slotAt;

    @Enumerated(EnumType.STRING)
    @Column(nullable = false, length = 16)    private BookingStatus status;
