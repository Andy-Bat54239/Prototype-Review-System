...
public class EmailService {
    ...
    /**
     * Notifies a supervisor that one of their bookings just changed state.
     * {@code event} is a human-readable verb like "scheduled" or "cancelled".
     */
    public void sendSupervisorAlert(String supervisorEmail, String supervisorName,
        ...
        send(supervisorEmail,
                "Session " + event + " — " + studentName,
